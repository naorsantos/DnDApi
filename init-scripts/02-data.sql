...
Aprimoramento de Truque. O dano aumenta em 1d6 quando você atinge os níveis 5 (2d6), 11 (3d6) e 17 (4d6).'
	...
	,'Ação'
	,'Druida,Artífice'
	,'V, S, M (o caule de uma planta espinhosa)'
	,'EVOCACAO'
	,'Instantânea'
	,'9 metros (6)'
	,61
...
Usando um Espaço de Magia de Círculo Superior. O dano aumenta em 2d8 para cada círculo de espaço de magia acima de 6.'
	...
	,FALSE
	,'Ação'
	,'Clérigo,Mago,Paladino,Artífice'
	,'V'
	,'ABJURACAO'
	,'Concentração, até 10 minutos'
	,'Pessoal'
...
Você pode criar um círculo de teleporte permanente conjurando essa magia no mesmo local todos os dias por 365 dias.'
	...
	,'1 minuto'
	,'Bardo,Bruxo,Feiticeiro,Mago'
	,'V, M (tintas raras no valor de 50 ou mais PO, que a magia consome)'
	,'INVOCACAO'
	,'1 rodada'
	,'3 metros (2)'
	,65
...
Usando um Espaço de Magia de Círculo Superior. A duração aumenta em 1 hora para cada círculo de espaço de magia acima de 3.'
	,FALSE
	,'1 minuto'
	,'Clérigo,Bruxo,Mago,Paladino'
	,'V, S, M (sal e prata em pó no valor de 100 ou mais PO, que a magia consome)'
	,'ABJURACAO'
	,'1 hora'
	,'3 metros (2)'
	,66
...
Uma criatura que veja o sensor (como uma criatura que se beneficia de Ver o Invisível ou Visão Verdadeira) enxerga uma esfera luminosa do tamanho do seu punho.'
	,FALSE
	,'10 minutos'
	,'Bardo,Clerigo,Feiticeiro,Mago'
	,'V, S, M (um foco no valor de 100 ou mais PO, seja um chifre adornado com joias e usado para escutar, ou um olho de vidro usado para enxergar)'
	,'ADIVINHACAO'
	,'Concentração, até 10 minutos'
	,' 1,5 km'
	,67
...
Se a criatura original morrer após o clone terminar de se formar, a alma da criatura é transferida para o clone se a alma estiver livre e disposta a retornar. O clone é fisicamente idêntico ao original e tem a mesma personalidade, memórias e habilidades, mas nenhum dos equipamentos do original. Os restos originais da criatura, se houver, tornam-se inertes e não podem ser revividos, uma vez que a alma da criatura está em outro lugar.'
	...
	,'1 minuto'
	,'Clérigo,Bruxo,Mago,Paladino'
	,'V, S, M (um diamante no valor de 1.000 ou mais PO, que a magia consome, e um recipiente vedável no valor de 2.000 ou mais PO que seja grande o suficiente para conter a criatura sendo clonada)'
	,'NECROMANCIA'
	,'Instantânea'
	,'Toque'
	,68
...
Vulnerabilidade. Criaturas de qualquer tipo que você escolher têm Vulnerabilidade a um tipo de dano à sua escolha enquanto estiverem na área.'
	...
	,'24 horas'
	,'Clérigo'
	,'V, S, M (incenso no valor de 1.000 ou mais PO, que a magia consome)'
	,'ABJURACAO'
	,'Até ser dissipada'
	,'Toque'
	,77
...
A magia contingente tem efeito apenas em você, mesmo que normalmente possa ter como alvo outros. Você pode usar apenas uma magia Contingência por vez. Se você conjurar esta magia novamente, o efeito de outra magia Contingência em você encerra. Além disso, a Contingência encerra em você se o componente material da magia não estiver em sua pessoa..'
	...
	,'10 minutos'
	,'Mago'
	,'V, S, M (uma estatueta de si mesmo incrustada de pedras preciosas no valor de 1.500 ou mais PO)'
	,'ABJURACAO'
	,'10 dias'
	,'Pessoal'
	,80
	...
	,FALSE
	,'Reação, que você executa quando vê uma criatura a até 18 metros de você conjurando uma magia com componentes Verbais, Somáticos'
	,'Bruxo, Feiticeiro, Mago'
	,'S'
	,'ABJURACAO'
	,'Instantânea'
...
Apenas um Familiar. Você não pode ter mais de um familiar ao mesmo tempo. Ao conjurar esta magia enquanto você tem um familiar, você faz com que ele adote uma nova forma elegível.'
	...
	,'1 hora'
	,'Mago'
	,' V, S, M (incenso queimando no valor de 10 ou mais PO, que a magia consome)'
	,'INVOCACAO'
	,'Instantânea'
	,'3 metros (2)'
	,86
...
Malandro. O espírito preenche um Cubo de 3 metros de lado a até 1,5 metro dele com Escuridão mágica, que dura até o final do próximo turno dele.'
	,FALSE
	,'Ação'
	,'Bruxo, Druida, Guardião, Mago'
	,'V, S, M (uma flor dourada no valor de 300 ou mais PO)'
	,'INVOCACAO'
	,'Concentração, até 1 hora'
	,'27 metros (18)'
	,87
...
A transformação do solo é camuflada para parecer natural. Qualquer criatura que não consiga ver a área quando a magia é conjurada deve executar uma ação Procurar e ser bem-sucedida em um teste de Sabedoria (Percepção ou Sobrevivência) contra a CD para evitar sua magia para reconhecer o terreno como perigoso antes de entrar nele.'
	,FALSE
	,'Ação (Crescimento Excessivo) ou 8 horas (Fertilização)'
	,'Bardo, Druida, Guardião'
	,'V, S'
	,'TRANSMUTACAO'
	,'Instantânea'
...
Usando um Espaço de Magia de Círculo Superior. Se você usar um espaço de magia de 7º círculo, você pode animar ou reafirmar o controle sobre quatro Carniçais. Se você usar um espaço de magia de 8º círculo, você pode animar ou reafirmar o controle sobre dois Carneçais ou Inumanos ou cinco Carniçais. Se você usar um espaço de magia de 9º círculo, poderá animar ou reafirmar o controle sobre seis Carniçais, três Carneçais ou Inumanos, ou duas Múmias. Veja também o Livro dos Monstros para esses blocos de estatísticas.'
	...
	,'1 minuto'
	,'Bruxo, Clérigo, Mago'
	,'V, S, M (uma pedra de ônix preto de 150 ou mais PO para cada cadáver)'
	,'NECROMANCIA'
	,'Instantânea'
	,'3 metros (2)'
	,99
...
Usando um Espaço de Magia de Círculo Superior. A cura aumenta em 2d8 para cada círculo de espaço de magia acima de 1.'
	,FALSE
	,'Ação'
	,'Bardo, Clérigo, Druida, Guardião, Paladino, Artífice'
	,'V, S'
	,'ABJURACAO'
	,'Instantânea'
	,'Toque'
...
Usando um Espaço de Magia de Círculo Superior. Sua Concentração pode durar mais com um espaço de magia de 2º círculo (em até 4 horas), 3º–4º círculo (em até 8 horas) ou 5º círculo ou superior (em até 24 horas).'
	...
	,'Ação Bônus'
	,'Bruxo'
	,'V, S, M (o olho petrificado de uma salamandra)'
	,'ENCANTAMENTO'
	,'Concentração, até 1 hora'
	,'27 metros (18)'
	,107
...
O alvo desperto tem a condição Enfeitiçado por 30 dias ou até que você ou seus aliados lhe causem dano. Quando essa condição termina, a criatura despertada decide qual atitude tem em relação a você.'
	...
	,'Ação'
	,'Bardo, Druida'
	,'V, S, M (uma ágata no valor de 1.000 ou mais PO, que a magia consome)'
	,'TRANSMUTACAO'
	,'Instantânea'
	,'Toque'
	,115
...
A magia é bloqueada por 30 centímetros de pedra, terra ou madeira, 2,5 centímetros de metal ou uma folha fina de chumbo.'
	,TRUE
	,'Ação'
	,'Bardo, Bruxo, Clérigo, Druida, Feiticeiro, Guardião, Mago, Paladino, Artífice'
	,'V, S'
	,'ADIVINHACAO'
	,'Concentração, até 10 minutos'
	,'Pessoal'
...
A magia é bloqueada por 30 centímetros de pedra, terra ou madeira, 2,5 centímetros de metal ou uma folha fina de chumbo.'
	,TRUE
	,'Ação'
	,'Clérigo, Druida, Guardião, Paladino'
...
Para descobrir se você está disfarçado, uma criatura deve executar a ação Analisar para inspecionar sua aparência e ser bem-sucedido em um teste de Inteligência (Investigação) contra a CD para evitar sua magia.'
	,FALSE
	,'Ação'
	,'Bardo, Feiticeiro, Mago, Artífice'
	,'V, S'
	,'ILUSAO'
	,'1 hora'
	,'Pessoal'
...
Esculpir Elemento. Você faz com que terra, areia, fogo, fumaça, névoa ou água que caiba em um Cubo de 30 centímetros de lado assuma uma forma rudimentar (como a de uma criatura) por 1 hora.'
	,FALSE
	,'Ação'
	,'Druida, Feiticeiro, Mago, Artífice'
	,'V,S'
	,'TRANSMUTACAO'
	,'Instantânea'
	,'9 metros (6)'
...
Usando um Espaço de Magia de Círculo Superior. Você pode escolher uma criatura adicional para cada círculo de espaço de magia acima de 2.'
	,false
	,'Ação'
	,'Bruxo, Feiticeiro, Mago, Artífice'
...
Uma criatura que possui Visão Verdadeira pode ler a mensagem oculta.'
	...
	,'1 minuto'
	,'Bardo, Bruxo, Mago'
	,'S, M (tinta no valor de 10 ou mais PO, que a magia consome)'
	,'ILUSAO'
	,'10 dias'
	,'Toque'
	,145
	...
	,TRUE
	,'Reação, que você executa quando é atingido por uma jogada de ataque ou é alvo da magia Mísseis Mágicos'
	,'Feiticeiro, Mago'
	,'V, S'
	,'ABJURACAO'
	,'1 rodada'
...
Se qualquer área desta magia se sobrepuser a uma área de Luz Plena ou Meia-luz criada por uma magia de 2º círculo ou inferior, essa outra magia é dissipada.'
	...
	,'Ação'
	,'Bruxo, Feiticeiro, Mago'
	,'V, M (pelo de morcego e um pedaço de carvão'
	,'EVOCACAO'
	,'Concentração, até 10 minutos'
	,'18 metros (12)'
	,149
...
Esta magia dissipa Escuridão criada por qualquer magia em sua área.'
	...
	,'V, S, M (um pedaço de pedra solar)'
	,'EVOCACAO'
	,'Instantânea'
	,'45 metros (30)'
	,159
...
Usando um Espaço de Magia de Círculo Superior. O dano para ambos os efeitos da magia aumenta em 1d8 para cada círculo de espaço de magia acima de 3.'
	,FALSE
	,'Ação Bônus, que você realiza imediatamente após atingir ou errar um alvo com um ataque à distância usando uma arma'
	,'Guardião'
	,'V, S'
	,'TRANSMUTACAO'
	,'Instantânea'
...
Usando um Espaço de Magia de Círculo Superior. O dano Ácido ou Gélido (à sua escolha) aumenta em 1d6 para cada círculo de espaço de magia acima de 3.'
	...
	,'Ação'
	,'Bardo, Druida, Artífice'
	,'V, S, M (um tentáculo em conserva)'
	,'INVOCACAO'
	,'Concentração, até 1 minuto'
	,'45 metros (30)'
	,170
...
Usando um Espaço de Magia de Círculo Superior. O dano de uma runa explosiva aumenta em 1d8 para cada círculo de espaço de magia acima de 3. Se você criar um glifo de magia, você pode armazenar qualquer magia de até o mesmo círculo que o espaço de magia que você usa para o Glifo de Proteção.'
	,FALSE
	,'1 hora'
	,'Bardo, Clérigo, Mago, Artífice'
	,'V, S, M (um diamante em pó no valor de 200 ou mais PO, que a magia consome)'
	,'ABJURACAO'
	,'Até ser dissipada ou acionada'
	,'Toque'
	,177
	)
	,(
...
Aprimoramento de Truque. Seja o dano Radiante ou o tipo de dano normal da arma, o ataque causa dano Radiante adicional quando você atinge os níveis 5 (1d6), 11 (2d6) e 17 (3d6).'
	,FALSE
	,'Ação'
	,'Bardo, Bruxo, Feiticeiro, Mago, Artífice'
	,'S, M (uma arma com a qual você tem proficiência e que vale 1 ou mais PC)'
	,'ADIVINHACAO'
	,'Instantânea'
	,'Pessoal'
	,179
...
Você então se teleporta para um espaço desocupado à sua vista a até 1,5 metro de um dos alvos.'
	...
	,'Ação'
	,'Guardião, Mago'
	,'S, M (uma arma Corpo a Corpo que vale 1 ou mais PP)'
	,'INVOCACAO'
	,'Instantânea'
	,'9 metros (6)'
	,181
...
Quando a graxa aparece, cada criatura em pé e na área da magia deve ser bem-sucedida em uma salvaguarda de Destreza ou tem a condição Caído. Uma criatura que entra na área ou termina o turno nela também deve ser bem-sucedida nessa salvaguarda ou fica Caída.'
	...
	,'Ação'
	,'Feiticeiro, Mago, Artífice'
	,'V, S, M (um pouco de banha de porco ou manteiga)'
	,'INVOCACAO'
	,'1 minuto'
	,'18 metros (12)'
	,182
...
Se em vez disso você tocar uma criatura durante a conjuração, você descobre quais magias a estão afetando, caso estejam.'
	...
	,'1 minuto '
	,'Bardo, Mago, Artífice'
	,'V, S, M (uma pérola no valor de 100 ou mais PO)'
	,'ADIVINHACAO'
	,'Instantânea'
	,'Toque'
	,185
...
A interação física com a imagem revela que ela é uma ilusão, pois as coisas podem passar por ela. Uma criatura que executa uma ação Analisar para examinar a imagem pode determinar que ela é uma ilusão com um teste bem-sucedido de Inteligência (Investigação) contra a CD para evitar sua magia. Se uma criatura perceber a ilusão pelo que ela é, a criatura pode ver através da imagem.'
	...
	,'Ação'
	,'Bardo, Guardião, Mago'
	,'V, S, M (uma pitada de poeira de diamante no valor de 25 ou mais PO, que a magia consome)'
	,'ABJURACAO'
	,'8 horas'
	,'Toque'
	,190
...
Se um teto ou objeto ancorado for encontrado nessa subida, criaturas e objetos colidem com ele como em uma queda normal. Se chegarem ao topo do Cilindro sem colidir com nada, pairam lá pela duração da magia. Quando a magia termina, criaturas e objetos afetados caem.'
	...
	,'Ação'
	,'Druida, Feiticeiro, Mago'
	,'V, S, M (uma pedra-ímã e raspas de ferro)'
	,'TRANSMUTACAO'
	,'Concentração, até 1 minuto'
	,'30 metros (20)'
	,193
...
Usando um Espaço de Magia de Círculo Superior. Você pode escolher uma criatura adicional para cada círculo de espaço de magia acima de 2.'
	...
	,'Ação'
	,'Bardo, Bruxo, Feiticeiro, Mago, Artífice'
	,'V, S, M (um cílio envolto em goma arábica)'
	,'ILUSAO'
	,'Concentração, até 1 hora'
	,'Toque'
	,194
...
Usando um Espaço de Magia de Círculo Superior. O dano aumenta em 1d8 para cada círculo de espaço de magia acima de 3.'
	...
	,'Ação'
	,'Guardião'
	,'V, S, M (uma arma Corpo a Corpo ou à Distância que vale pelo menos 1 PP)'
	,'INVOCACAO'
	,'Instantânea'
	,'Pessoal'
	,199
...
Respirar na Água (Apenas Água). O espírito só pode respirar debaixo dágua.
...
Cada criatura à sua escolha à sua vista em um Cilindro de 12 metros de raio e 6 metros de altura, centrada nesse ponto, realiza uma salvaguarda de Destreza. Uma criatura sofre 8d8 pontos de dano Energético se falhar, ou metade desse dano em caso de sucesso.'
	...
	,'Ação'
	,'Guardião'
	,'V, S, M (uma arma Corpo a Corpo ou à Distância no valor de 1 ou mais PP)'
	,'INVOCACAO'
	,'Instantânea'
	,'45 metros (30)'
	,209
...
O conhecimento pode incluir detalhes significativos, revelações intrigantes ou até mesmo informações secretas que nunca foram amplamente divulgadas. Quanto mais você já sabe sobre o assunto, mais precisas e detalhadas se tornam as informações que recebe. Essas informações são exatas, mas podem ser expressas em linguagem figurada ou poesia, conforme determinado pelo Mestre. Se a coisa famosa que você escolheu não for realmente famosa, você ouve notas musicais tristes tocadas em um trombone, e a magia falha.'
	...
	,'10 minutos'
	,'Bardo, Clérigo, Mago'
	,'V, S, M (incenso no valor de 250 ou mais PO, que a magia consome, e quatro tiras de marfim no valor de 50 ou mais PO cada)'
	,'ADIVINHACAO'
	,'Instantânea'
	,'Pessoal'
	,213
...
Esta magia não pode localizar uma criatura se qualquer espessura de chumbo bloquear um caminho direto entre você e a criatura.'
	,FALSE
	,'Ação'
	,'Bardo, Clérigo, Druida, Guardião, Mago, Paladino'
	,'V, S, M (pelo de um cão de caça)'
	,'ADIVINHACAO'
	,'Concentração, até 1 hora'
	,'Pessoal'
...
Como uma Ação Bônus em seus turnos posteriores, você pode alterar a direção da Linha soprada por você'
	,FALSE
	,'Ação'
	,'Druida, Feiticeiro, Guardião, Mago'
	,'V, S, M (a semente de um legume)'
	,'EVOCACAO'
	,'Concentração, até 1 minuto'
	,'Pessoal'
	,224
...
Cobrir o objeto com algo opaco bloqueia a luz. A magia se encerra se você a conjurar novamente.'
	,FALSE
	,'Ação'
	,'Bardo, Clérigo, Feiticeiro, Mago, Artífice'
...
Se qualquer área desta magia se sobrepuser a uma área de Escuridão criada por uma magia de 3º círculo ou inferior, essa outra magia é dissipada.'
	,FALSE
	,'Ação'
	,'Clérigo, Druida, Feiticeiro, Guardião, Paladino'
	,'V, S'
	,'EVOCACAO'
	,'1 hora'
	,'18 metros (12)'
...
Quando a magia termina, qualquer criatura ou objeto deixado no espaço extradimensional é expulso para os espaços desocupados mais próximos à entrada.'
	...
	,'1 minuto'
	,'Bardo, Mago'
	,'V, S, M (uma porta em miniatura no valor de 15 ou mais PO)'
	,'INVOCACAO'
	,'24 horas'
	,'90 metros (60)'
	,229
...
Você pode conjurar essa magia através de objetos sólidos se estiver familiarizado com o alvo e souber que ele está além da barreira. Silêncio mágico, 30 centímetros de pedra, metal ou madeira, ou uma fina folha de chumbo bloqueiam a magia.'
	,FALSE
	,'Ação'
	,'Bardo, Druida, Feiticeiro, Mago, Artífice'
	,'S, M (um fio de cobre)'
	,'TRANSMUTACAO'
	,'1 rodada'
	,'36 metros (24)'
...
Ao se multimorfar, você decide se seu equipamento cai no chão ou se altera em tamanho e forma para se ajustar à nova forma enquanto você a mantém.'
	...
	,'Ação'
	,'Druida, Mago'
	,'V, S, M (uma argola de jade no valor de 1.500 ou mais PO)'
	,'TRANSMUTACAO'
	,'Concentração, até 1 hora'
	,'Pessoal'
	,240
...
Usando um Espaço de Magia de Círculo Superior. Você pode escolher uma criatura adicional para cada círculo de espaço de magia acima de 4.'
	,FALSE
	,'Ação'
	,'Bardo, Clérigo, Druida, Guardião, Artífice'
	,'V, S, M (uma alça de couro)'
	,'ABJURACAO'
	,'1 hora'
	,'Toque'
	,249
...
Como uma Ação Bônus, você pode mover o olho até 9 metros em qualquer direção. Uma barreira sólida bloqueia o movimento do olho, mas o olho pode passar por uma abertura de até 2,5 centímetros de diâmetro.'
	...
	,'Ação'
	,'Mago, Artífice'
	,'V, S, M (um pouco de pele de morcego)'
	,'ADIVINHACAO'
	,'Concentração, até 1 hora'
	,'9 metros (6)'
	,263
...
Aprimoramento de Truque. O dano aumenta em 1d6 quando você atinge os níveis 5 (2d6), 11 (3d6) e 17 (4d6).'
	...
	,'Ação'
	,'Clérigo'
	,'V, M (um símbolo com um raio de sol)'
	,'EVOCACAO'
	,'Instantânea'
	,'Pessoal'
	,276
...
Usando um Espaço de Magia de Círculo Superior. Você pode escolher um Humanoide adicional para cada círculo de espaço de magia acima de 2.'
	,FALSE
	,'Ação'
	,'Bardo, Bruxo, Clérigo, Druida, Feiticeiro, Mago'
	,'V, S, M (um pedaço reto de ferro)'
	,'ENCANTAMENTO'
	,'Concentração, até 1 minuto'
	,'18 metros (12)'
...
Você pode usar essa habilidade de transporte apenas uma vez em cada um dos seus turnos. Você deve terminar cada turno fora de uma árvore.'
	...
	,'Ação'
	,'Druida, Guardião'
	,'V, S, M (cinzas de ramo de visco queimado'
	,'ABJURACAO'
	,'Concentração, até 1 hora'
	,'Pessoal'
	,284
...
Usando um Espaço de Magia de Círculo Superior. Você pode escolher uma criatura adicional para cada círculo de espaço de magia acima de 1.'
	,FALSE
	,'Ação'
	,'Bardo, Druida, Guardião, Mago, Artífice'
	,'V, S, M (uma pitada de poeira)'
	,'ABJURACAO'
	,'1 hora'
	,'Toque'
	,285
	...
	,'Ação Bônus'
	,'Druida, Guardião'
	,'V, S, M (um punhado de casca de árvore)'
	,'TRANSMUTACAO'
	,'1 hora'
	,'Toque'
	,286
	...
	,FALSE
	,'Ação'
	,'Druida, Feiticeiro, Guardião, Mago, Artífice'
	,'V, S, M (poeira de diamante no valor de 100 ou mais PO, que a magia consome)'
	,'TRANSMUTACAO'
	,'Concentração, até 1 hora'
	,'Toque'
	,287
...
O alvo recebe um número de Pontos de Vida Temporários igual aos Pontos de Vida da forma de Fera. A magia se encerra no alvo se ele não tiver Pontos de Vida Temporários restantes. Esses Pontos de Vida Temporários desaparecem, caso ainda restem, quando a magia terminar.
...
Criatura em Objeto. Se você transformar uma criatura em um objeto, ela se transforma junto com o que quer que esteja vestindo e carregando nessa forma, desde que o tamanho do objeto não seja maior do que o tamanho da criatura. As estatísticas da criatura se tornam as do objeto, ela não tem memórias do período que passou em forma de objeto e volta ao normal após a magia terminar.'
	...
	,'Ação'
	,'Bardo, Bruxo, Mago'
	,'V, S, M (uma gota de mercúrio, uma porção de goma arábica e um fiapo de fumaça)'
	,'TRANSMUTACAO'
	,'Concentração, até 1 hora'
	,'9 metros (6)'
	,292
...
Se você conjurar a magia mais de uma vez antes de completar um Descanso Longo, há uma chance cumulativa de 25% para cada conjuração após a primeira de que você não receba resposta.'
	...
	,'Ação'
	,'Clérigo, Druida, Mago'
	,'V, S, M (incenso no valor de 25 ou mais PO, que a magia consome)'
	,'ADIVINHACAO'
	,'Instantânea'
	,'Pessoal'
	,298
...
Quando a magia termina para um alvo que não está morto, o alvo reaparece em seu corpo e sai do estado de animação suspensa.'
	...
	,'1 hora'
	,'Clérigo, Bruxo, Mago'
	,'V, S, M (para cada um dos alvos da magia, um zircão no valor de 1.000 ou mais PO e uma barra de prata no valor de 100 ou mais PO, que a magia consome)'
	,'NECROMANCIA'
	,'Até ser dissipada'
	,'3 metros (2)'
	,301
...
Interação física com a imagem revela sua natureza ilusória, já que objetos podem atravessá-la. Uma criatura que executa a ação Analisar para examinar a imagem pode determinar que se trata de uma ilusão com um teste bem-sucedido de Inteligência (Investigação) contra a CD para evitar sua magia. Se uma criatura perceber a ilusão, ela pode ver através da imagem, e qualquer som que a ilusão emita parece vago para essa criatura.'
	...
	,'Ação'
	,'Bardo, Mago'
	,'V, S, M (uma estatueta de si mesmo no valor de 5 ou mais PO)'
	,'ILUSAO'
	,'Concentração, até 1 dia'
	,'800 metros (533)'
	,302
...
Se a magia ainda estiver ativa quando o alvo for submetido a um efeito que o mate instantaneamente sem causar dano, esse efeito é negado contra o alvo e a magia se encerra.'
	...
	,FALSE
	,'Ação'
	,'Clérigo, Druida, Feiticeiro, Guardião, Mago, Artífice'
	,'V, S'
	,'ABJURACAO'
	,'Concentração, até 1 hora'
	,'Toque'
	...
	,FALSE
	,'Ação'
	,'Clérigo, Bruxo, Druida, Mago, Paladino'
	,'V, S, M (um pote de Água Benta no valor de 25 ou mais PO, que a magia consome)'
	,'ABJURACAO'
	,'Concentração, até 10 minutos'
	,'Toque'
	,306
	...
	,FALSE
	,'Ação'
	,'Clérigo, Druida, Guardião, Paladino, Artífice'
	,'V, S'
	,'ABJURACAO'
	,'1 hora'
	,'Toque'
...
Sugestão em um quadrado de 1,5 metro de lados; qualquer criatura que entre nesse quadrado recebe a sugestão mentalmente'
	...
	,(
	'Purificar Alimentos e Bebidasa'
	,1
	...
	,TRUE
	,'Ação'
	,'Clérigo, Druida, Paladino, Artífice'
	,'V, S'
	,'TRANSMUTACAO'
	,'Instantânea'
	,'3 metros (2)'
	...
	,FALSE
	,'Reação, que você executa quando você ou uma criatura à sua vista a até 18 metros de você entra em queda'
	,'Bardo, Feiticeiro, Mago, Artífice'
...
Usando um Espaço de Magia de Círculo Superior. O dano aumenta em 1d10 para cada círculo de espaço de magia acima de 2..'
	...
	,'Ação'
	,'Druida'
	,'V, S, M (uma folha de dama-da-noite)'
	,'EVOCACAO'
	,'Concentração, até 1 minuto'
	,'36 metros (24)'
	,317
...
Aprimoramento de Truque. O dano aumenta em 1d12 quando você atinge os níveis 5 (2d12), 11 (3d12) e 17 (4d12).'
	,FALSE
	,'Ação'
	,'Bruxo, Druida, Feiticeiro, Mago, Artífice'
	,'V, S, M (uma lupa)'
	,'NECROMANCIA'
	,'Instantânea'
	,'9 metros (6)'
...
A criatura reencarnada faz quaisquer escolhas que a descrição de sua nova espécie oferece e mantém as memórias de sua vida anterior. Ela conserva as capacidades que possuía em sua forma original, mas perde os traços da espécie anterior e adquire os traços da nova espécie.'
	...
	,'1 hora'
	,'Druida'
	,'V, S, M (óleos raros no valor de 1.000 ou mais PO, que a magia consome)'
	,'NECROMANCIA'
	,'Instantânea'
	,'Toque'
	,324
...
Você pode definir uma condição para que a magia encerre previamente. A condição pode ser qualquer coisa à sua escolha, mas deve ocorrer ou ser visível em um raio de 1,5 quilômetro do alvo. Exemplos incluem “após 1.000 anos” ou “quando o tarrasque despertar”. A magia também encerra se o alvo sofrer qualquer dano.'
	...
	,'Ação'
	,'Mago'
	,'V, S, M (poeira de uma pedra preciosa no valor de 5.000 ou mais PO, que a magia consome)'
	,'ILUSAO'
	,'Até ser dissipada'
	,'Toque'
	,326
...
Usando um Espaço de Magia de Círculo Superior. O dano aumenta em 1d6 para cada círculo de espaço de magia acima de 3.'
	...
	,'Ação'
	,'Feiticeiro, Mago'
	,'V, S, M (um pouco de pelo e um cajado de cristal)'
	,'ILUSAO'
	,'Instantânea'
	,'Toque'
	,328
...
Usando um Espaço de Magia de Círculo Superior. O dano aumenta em 1d10 para cada círculo de espaço de magia acima de 1.'
	,FALSE
	,'Reação, que você realiza ao receber dano de uma criatura à sua vista e a até 18 metros de você'
	,'Bruxo'
	,'V, S'
	,'EVOCACAO'
	,'Instantânea'
	...
	'Respirar na Água'
	,3
	,'Esta magia concede a até dez criaturas voluntárias à sua escolha no alcance da magia a capacidade de respirar debaixo dágua até que a magia termine. As criaturas afetadas também mantêm seu modo normal de respiração.'
	,TRUE
	,'Ação'
	,'Druida, Feiticeiro, Guardião, Mago, Artífice'
	,'V, S, M (um pedaço de junco)'
	,'ABJURACAO'
	,'24 horas'
	,'9 metros (6)'
	,334
...
Conjurar essa magia para reviver uma criatura morta há 365 dias ou mais sobrecarrega você. Até completar um Descanso Longo, você não pode conjurar magias novamente e tem Desvantagem nos Testes de D20.'
	...
	,'1 hora'
	,'Bardo, Clérigo'
	,'V, S, M (um diamante no valor de 1.000 ou mais PO, que a magia consome)'
	,'ABJURACAO'
	,'Instantânea'
	,'Toque'
	,335
...
A magia pode criar um novo corpo se o original não existir mais; nesse caso, você deve pronunciar o nome da criatura. A criatura então aparece em um espaço desocupado à sua escolha, a até 3 metros de você.'
	...
	,'1 hora'
	,'Clérigo, Druida'
	,'V, S, M (diamantes no valor de 25.000 ou mais PO, que a magia consome)'
	,'NECROMANCIA'
	,'Instantânea'
	,'Toque'
	,336
...
Voltar à vida é um processo difícil. O alvo sofre uma penalidade de -4 em Testes de D20. Sempre que o alvo completar um Descanso Longo, a penalidade é reduzida em 1 até se tornar 0.'
	...
	,'1 hora'
	,'Bardo, Clérigo, Paladino'
	,'V, S, M (um diamante no valor de 500 ou mais PO, que a magia consome)'
	,'NECROMANCIA'
	,'Instantânea'
	,'Toque'
	,340
	...
	,'Ação'
	,'Clérigo, Druida, Guardião, Paladino, Artífice'
	,'V, S, M (um diamante no valor de 300 ou mais PO, que a magia consome)'
	,'NECROMANCIA'
	,'Instantânea'
	,'Toque'
	,341
...
Usando um Espaço de Magia de Círculo Superior. Você pode escolher uma criatura adicional para cada círculo de espaço de magia acima de 1.'
	...
	,'Ação Bônus'
	,'Druida, Feiticeiro, Guardião, Mago, Artífice'
	,'V, S, M (perna traseira de um gafanhoto)'
	,'TRANSMUTACAO'
	,'1 minuto'
	,'Toque'
	,343
...
Usando um Espaço de Magia de Círculo Superior. Você pode aumentar o tamanho do Cubo em 30 metros para cada círculo de espaço de magia acima de 4.'
	...
	,'10 minutos'
	,'Mago, Artífice'
	,'V, S, M (uma folha fina de chumbo)'
	,'ABJURACAO'
	,'24 horas'
	,'36 metros (24)'
	,345
...
Usando um Espaço de Magia de Círculo Superior. Você pode aumentar o tamanho do Cubo em 30 metros para cada círculo de espaço de magia acima de 4.'
	,FALSE
	,'Ação Bônus, que você realiza imediatamente após atingir uma criatura com um ataque com arma à Distância'
	,'Guardião'
	,'V'
	,'INVOCACAO'
	,'Instantânea'
...
Sono. Cada alvo deve ser bem-sucedido em uma salvaguarda de Sabedoria ou tem a condição Inconsciente por 10 minutos. Uma criatura desperta se sofrer dano ou se alguém executar uma ação para sacudi-la.'
	...
	,'1 minuto'
	,'Bardo, Clérigo, Guardião'
	,'V, S, M (um diamante em pó no valor de 1.000 ou mais PO, que a magia consome)'
	,'ABJURACAO'
	,'Até ser dissipada ou acionada'
	,'Toque'
	,352
...
Usando um Espaço de Magia de Círculo Superior. O dano aumenta em 1d6 para cada círculo de espaço de magia acima de 3.'
	...
	,'Ação'
	,'Mago, Artífice'
	,'V, S, M (pó de ouro no valor de 25 ou mais PO, que a magia consome)'
	,'ABJURACAO'
	,'Até ser dissipada'
	,'Toque'
	,380
...
Como alternativa, se você souber a sequência de símbolos de um círculo de teleporte em outro plano de existência, esta magia pode levá-lo a esse círculo. Se o círculo de teleporte for pequeno demais para caber todas as criaturas que você transportou, elas aparecem nos espaços desocupados mais próximos ao círculo.'
	,FALSE
	,'Ação'
	,'Bruxo, Clérigo, Druida, Feiticeiro, Mago'
	,'V, S, M (uma haste de metal bifurcada no valor de 250 ou mais PO e sintonizada a um plano de existência)'
	,'INVOCACAO'
	,'Instantânea'
	,'Toque'
	,381
...
Aprimoramento de Truque. O dano aumenta em 1d6 quando você atinge os níveis 5 (2d6), 11 (3d6) e 17 (4d6).'
	,FALSE
	,'Ação'
	,'Bardo, Bruxo, Druida, Feiticeiro, Mago, Artífice'
	,'S'
	,'INVOCACAO'
	,'Instantânea'
	,'Pessoal'
...
Em vez de uma criatura, você pode escolher um local que viu. Ao fazer isso, o sensor aparece nesse local e não se move.'
	,FALSE
	,'Ação'
	,'Bardo, Bruxo, Clérigo, Druida, Mago'
	,'V, S, M (um foco no valor de 1.000 ou mais PO, como uma bola de cristal, espelho ou fonte cheia de água)'
	,'ADIVINHACAO'
	,'Concentração, até 10 minutos'
	,'Pessoal'
	,387
...
A magia se encerra se você for reduzido a 0 Pontos de Vida, se você e o alvo ficarem a mais de 18 metros de distância ou se for conjurada novamente em qualquer uma das criaturas conectadas..'
	...
	,'Ação Bônus'
	,'Clérigo, Paladino'
	,'V, S, M (um par de anéis de platina no valor de 50 ou mais PO cada, que você e o alvo devem usar pela duração da magia)'
	,'ABJURACAO'
	,'1 hora'
	,'Toque'
	,389
...
Usando um Espaço de Magia de Círculo Superior. O número de criaturas que a vinha pode imobilizar aumenta em um para cada círculo de espaço de magia acima de 4.'
	...
	,'Ação'
	,'Bardo, Bruxo, Clérigo, Feiticeiro, Mago'
	,'V, S, M (cogumelo em pó no valor de 25 ou mais PO, que a magia consome)'
	,'ADIVINHACAO'
	,'1 hora'
	,'Toque'
	,391
